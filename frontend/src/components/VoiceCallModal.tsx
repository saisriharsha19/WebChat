                    ...
                    {callState.status === 'connected' && (
                        <>
                            ...
                            <div className="flex gap-6 justify-center">
                                <button
                                    onClick={toggleMute}
                                    className={`w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition-all hover:scale-105 ${isMuted ? 'bg-surface-sidebar text-txt-primary' : 'bg-surface-sidebar text-txt-primary'
                                        }`}
                            ...
                            <div className="mt-6 flex items-center gap-2 justify-center opacity-70">
                                <span className={`w-2 h-2 rounded-full ${connectionQuality === 'good' ? 'bg-green-500' :
                                    connectionQuality === 'fair' ? 'bg-yellow-500' : 'bg-red-500'
                                    }`}></span>
                                <span className="text-xs text-txt-tertiary uppercase tracking-wider font-semibold">
                                    {connectionQuality === 'good' ? 'HD Quality' :
                                        connectionQuality === 'fair' ? 'Standard Quality' : 'Low Bandwidth'}
                                </span>
                            </div>
                        </>
                    )}
