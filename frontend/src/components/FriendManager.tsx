                            ...
                            return (
                                <div key={friend.id} className="flex items-center gap-3 p-2 hover:bg-surface-hover rounded-lg group transition-colors cursor-pointer" onClick={() => onSelectUser(friend.id)}>
                                    ...
                                    <button
                                        ...
                                        className="p-2 text-txt-tertiary hover:text-txt-primary hover:bg-surface-hover rounded-md opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all"
